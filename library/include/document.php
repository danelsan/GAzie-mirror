...
class DocContabVars {
  ...
  public $currency;
    ...
    function setData($gTables, $tesdoc, $testat, $tableName, $ecr = false) {
      ...
      if(!$this->client){
        $this->client=['ragso1'=>': ','ragso2'=>'','pec_email'=>'','fe_cod_univoco'=>'','fe_cod_univoco'=>'','indspe'=>'','citspe'=>'','country'=>'IT','capspe'=>'','prospe'=>'','pariva'=>'','pariva'=>'','codfis'=>'','sedleg'=>'','fiscal_rapresentative_id'=>'','stapre'=>'','id_currency'=>1];
      }
      $this->client['id_currency'] = $this->client['id_currency'] < 1 ? 1 : $this->client['id_currency'];
