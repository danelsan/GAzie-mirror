...
$update_db[]="ALTER TABLE `".$table_prefix."_XXXrental_payments` ADD `id_paymov` INT(11) NOT NULL DEFAULT '0' COMMENT 'Connessione al movimento contabile di pagamento' AFTER `id_tesbro`;";
?>
