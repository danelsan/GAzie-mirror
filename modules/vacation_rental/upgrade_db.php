...
$upgrade_db[161][]="ALTER TABLE `".$table_prefix."_XXXrental_events` ADD `minor_children` INT(2) NOT NULL COMMENT 'Numero minori in età valida per esonero dal pagamento della tassa turistica' AFTER `child`; ";
?>
