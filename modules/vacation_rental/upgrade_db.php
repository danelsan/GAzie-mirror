...
$upgrade_db[161][]="ALTER TABLE `".$table_prefix."_XXXrental_events` ADD `ex_adults` INT(2) NOT NULL COMMENT 'Numero di adulti esonerati dal pagamento della tassa di soggiorno turistica' AFTER `child`, ADD `ex_minors` INT(2) NOT NULL COMMENT 'Numero di minori esonerati dal pagamento della tassa di soggiorno turistica' AFTER `ex_adults`; ";
?>
