...
' WHERE  `lang_id`=3;
UPDATE `gaz_languages` SET `emoji`='8J+HrvCfh7k=', `image_jpg`='' WHERE `lang_id`=1;
UPDATE `gaz_languages` SET `emoji`='8J+HrPCfh6c=', `image_jpg`='' WHERE `lang_id`=2;
UPDATE `gaz_languages` SET `emoji`='8J+HqvCfh7g=', `image_jpg`='' WHERE `lang_id`=3;
